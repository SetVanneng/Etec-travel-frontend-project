...
// The subjects offered in the dropdown.
...
<template>
  <div class="mx-auto max-w-6xl px-4 py-12 sm:px-6">
    <div class="mb-10 text-center">
      <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Contact Us</h1>
    ...
    <div class="grid gap-10 md:grid-cols-5">
      ...
      <aside class="md:col-span-2">
        <div class="rounded-2xl bg-slate-900 p-6 text-slate-300">
          ...
          <p class="mt-2 text-sm leading-relaxed text-slate-400">
            ...
            project nothing is actually sent anywhere - just a friendly toast.
          </p>
          ...
          <div class="mt-8 rounded-xl bg-slate-800 p-4">
            <p class="text-xs uppercase tracking-wider text-slate-500">Office hours</p>
            <p class="mt-1.5 text-sm">Monday - Friday, 9:00 to 18:00</p>
          </div>
        </div>
      </aside>
      ...
      >
        <div class="grid gap-5 sm:grid-cols-2">
          <label class="block">
            <span class="mb-1.5 flex items-center gap-1.5 text-sm font-semibold text-slate-700 dark:text-slate-200">
              <User :size="16" class="text-teal-600 dark:text-teal-400" /> Name
            </span>
            <input
              v-model="form.name"
              type="text"
        ...
        <label class="mt-5 block">
          <span class="mb-1.5 flex items-center gap-1.5 text-sm font-semibold text-slate-700 dark:text-slate-200">
            <Tag :size="16" class="text-teal-600 dark:text-teal-400" /> Subject
          </span>
          <select
        ...
        <label class="mt-5 block">
          <span class="mb-1.5 flex items-center gap-1.5 text-sm font-semibold text-slate-700 dark:text-slate-200">
            <MessageSquare :size="16" class="text-teal-600 dark:text-teal-400" /> Message
          </span>
          <textarea
